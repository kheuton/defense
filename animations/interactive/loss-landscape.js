...
const METHODS = [
  {
    ...
    katex: "\\mathcal{L}_\\text{DPO}(\\hat{y},y) = \\mathbb{E}_{\\varepsilon \\sim \\mathcal{N}(0,I)}\\!\\left[y^\\top \\hat{z}(\\hat{y} + \\sigma\\varepsilon)\\right] - V(y)",
  },
  {
    dataKey:  "spo_plus",
    label:    "SPO+",
    ...
    katex: "\\mathcal{L}_\\text{SPO+}(\\hat{y},y) = {-}V(2\\hat{y} - y) + 2\\hat{y}^\\top z^* - V(y)",
  },
  {
    dataKey:  "pgb",
    label:    "PGB",
    ...
    katex: "\\mathcal{L}_\\text{PGB}(\\hat{y},y) = \\dfrac{V(\\hat{y}) - V(\\hat{y} - h y)}{h} - V(y)",
  },
  {
    dataKey:  "dbb",
    label:    "DBB",
    ...
    katex: "\\mathcal{L}_\\text{DBB}(\\hat{y},y) = \\dfrac{V(\\hat{y} + \\lambda y) - V(\\hat{y})}{\\lambda} - V(y)",
  },
  {
    dataKey:  "lodl",
    label:    "LODL",
    ...
    katex: "\\mathcal{L}_\\text{LODL}(\\hat{y},y) = f_\\phi(\\hat{y}, y),\\quad \\phi \\text{ trained to mimic regret}",
  },
];
