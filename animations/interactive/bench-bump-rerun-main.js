...
const DATA = {
  regret: {
    knapsack:          { MSE:5.4385,DFL:6.7052,'Identity':23.8469,'SPO+':6.2646,NCE:14.8286,Blackbox:24.315,'pt-LTR':5.7965,'pr-LTR':7.8893,'L-LTR':5.8516,LODL:24.0259,Perturb:12.13,PG:11.1386,QPTL:20.0743,cpLayer:24.315 },
    'knapsack-real':   { MSE:7.6315,DFL:7.1128,'Identity':35.136,'SPO+':7.0089,NCE:12.05,Blackbox:36.5685,'pt-LTR':8.4238,'pr-LTR':10.9848,'L-LTR':7.1757,LODL:9.9221,Perturb:9.1507,PG:8.1214,QPTL:null,cpLayer:null },
    energy:            { MSE:1.9954,DFL:13.9125,'Identity':13.9733,'SPO+':1.8092,NCE:1.8914,Blackbox:6.6189,'pt-LTR':1.9931,'pr-LTR':2.0371,'L-LTR':2.0052,LODL:2.4379,Perturb:1.9704,PG:1.9291,QPTL:null,cpLayer:null },
    cubic:             { MSE:0.0324,DFL:2.2022,'Identity':13.8937,'SPO+':160.4079,NCE:142.6018,Blackbox:13.8937,'pt-LTR':0.0532,'pr-LTR':0.4178,'L-LTR':0.00883,LODL:4.218,Perturb:13.544,PG:4.8848,QPTL:null,cpLayer:null },
    bipartitematching: { MSE:91.8526,DFL:93.6941,'Identity':92.2284,'SPO+':92.2017,NCE:89.9987,Blackbox:92.6355,'pt-LTR':92.1469,'pr-LTR':90.9364,'L-LTR':89.803,LODL:93.9183,Perturb:93.8542,PG:92.4519,QPTL:92.046,cpLayer:92.003 },
  },
  avg_rank: { mse:3.4,dfl:7.0,identity:10.5,spo:5.2,nce:6.8,blackbox:11.2,pointLTR:4.6,pairLTR:6.0,listLTR:3.0,lodl:9.8,perturb:8.0,pg:6.4,qptl:8.0,cpLayer:9.25 },
};
...
const YAXIS = {
  ...
  _avgrank:          { type: 'lin', yMin: 1,    yMax: 12,   ticks: [2, 4, 6, 8, 10, 12], tickFmt: String },
};
